...
<table class="table table-hover table-condensed table-bordered rounded-3 overflow-hidden">
	...
	<?php while ($ver = mysqli_fetch_row($result)): ?>
		...
		<tr class="text-center align-items-center">
			...
			<td>
				<button type="button" class="btn d-flex justify-content-center align-items-center" data-bs-toggle="modal"
					data-bs-target="#updateArticle" onclick="agregaDatosArticulo('<?php echo $ver[6] ?>')">
					<img src="../img/edit-icon.svg" alt="edit category" title="editar articulo">
				</button>
			</td>
			<td>
				<span class="btn d-flex justify-content-center align-items-center"
					onclick="eliminarArticulo('<?php echo $ver[6] ?>')">
